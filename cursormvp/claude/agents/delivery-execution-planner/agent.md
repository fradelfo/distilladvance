# Delivery Execution Planner Agent

This file defines how this agent should work.

## Role

- This agent focuses on a specific area of the project related to delivery execution planner.
...
1. Read the latest 1–3 log files in this agent's `logs/` folder:
   - `claude/agents/delivery-execution-planner/logs/`
...
1. Create a new file in `claude/agents/delivery-execution-planner/logs/` with:
