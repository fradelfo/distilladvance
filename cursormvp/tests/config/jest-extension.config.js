...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$': '<rootDir>/tests/utils/__mocks__/fileMock.js'
  },
...
module.exports.contentScriptConfig = {
  ...
  setupFilesAfterEnv: [
    '<rootDir>/tests/utils/content-script-setup.ts'
  ]
};
...
module.exports.backgroundScriptConfig = {
  ...
  setupFilesAfterEnv: [
    '<rootDir>/tests/utils/background-script-setup.ts'
  ]
};
...
module.exports.popupConfig = {
  ...
  setupFilesAfterEnv: [
    '<rootDir>/tests/utils/popup-setup.ts'
  ]
};