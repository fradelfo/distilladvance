...
- This agent focuses on a specific area of the project related to discovery research.
...
1. Read the latest 1–3 log files in this agent's `logs/` folder:
   - `claude/agents/discovery-research/logs/`
...
1. Create a new file in `claude/agents/discovery-research/logs/` with:
