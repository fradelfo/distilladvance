...
- This agent focuses on a specific area of the project related to ux spec writer.
...
1. Read the latest 1–3 log files in this agent's `logs/` folder:
   - `claude/agents/ux-spec-writer/logs/`
...
1. Create a new file in `claude/agents/ux-spec-writer/logs/` with:
